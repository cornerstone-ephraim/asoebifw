...
export function ButtonsReference() {
      ...
      <div className="grid gap-5 md:grid-cols-2 2xl:grid-cols-4">
        ...
        >
          <button
            ...
            onClick={() => setMessage("Secondary action selected. Demo only.")}
          >
            Go back
          </button>
        </Specimen>
        ...
        >
          <button
            ...
            onClick={() => {
              setPressed(!pressed);
              setMessage(pressed ? "Demo menu closed." : "Demo menu selected.");
            }}
...
export function LinksReference() {
  return (
    <ReferenceSection
      id="links"
    ...
    >
      <div className="grid gap-5 md:grid-cols-3">
        ...
        >
          ...
          <p className="mt-5 text-sm">
            44px minimum height · 12px label · ↗ shifts 4px right and 2px up on
            hover/focus.
          </p>
        </Specimen>
        <Specimen
      ...
      <div className="mt-6 rounded-3xl bg-asoebi-purple-950 p-7 text-white">
        ...
        <ArrowLink href="/internal/design-system/imagery" inverse>
          See image guidance
        </ArrowLink>
      </div>
    </ReferenceSection>
