export function EditorialPlaceholder({
  ...
  label: string;
  tone?: "purple" | "gold" | "ink" | "ivory";
  className?: string;
}) {
  const tones = {
    purple:
      "from-asoebi-purple-950 via-asoebi-purple-700 to-asoebi-purple-300 text-white",
    ...
    ivory:
      "from-asoebi-mist via-asoebi-ivory to-asoebi-gold-100 text-asoebi-ink",
  };
  return (
    <div
      role="img"
