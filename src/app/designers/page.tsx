...
export const metadata = createMetadata({ title: "African Fashion Designers", description: "Meet the designers shaping contemporary Asoebi through innovative tailoring, textiles, craft and cultural storytelling.", path: "/designers", keywords: ["African fashion designers", "Nigerian designers", "Asoebi designers"] });
