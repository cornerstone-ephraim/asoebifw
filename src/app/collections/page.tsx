...
export const metadata = createMetadata({ title: "African Fashion Collections", description: "Explore original Asoebi Fashion Week collections shaped by African textiles, contemporary craft and distinct designer perspectives.", path: "/collections", keywords: ["African fashion collections", "Asoebi collections", "runway fashion"] });
