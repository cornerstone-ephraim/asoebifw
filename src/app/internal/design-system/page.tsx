...
const colors = [
  ...
  [
    "Coral",
    "#ef735d",
    "oklch(69.72% 0.1576 31.67)",
    "rgba(239, 115, 93, 1)",
    "A restrained supporting accent",
  ],
] as const;
          ...
          <div className="grid gap-12 pt-14 lg:grid-cols-[1.3fr_.7fr] lg:items-end">
            <div>
              ...
              <h1 className="font-display mt-5 text-[clamp(4.5rem,11vw,11rem)] leading-[.76] tracking-[-.07em]">
                ...
                <span className="block overflow-hidden">
                  <span data-ds-hero-line className="block text-brand">
                    by design.
                  </span>
                </span>
              </h1>
            ...
            {colors.map(([name, value, oklch, rgba, use]) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-xs text-sm opacity-65">{use}</p>
                </div>
              </article>
            ))}
          </div>
      ...
      <section className="px-5 py-24 lg:px-10 lg:py-36">
        <div className="mx-auto max-w-375">
          <div className="grid gap-10 lg:grid-cols-[.7fr_1.3fr]">
            ...
            <div
              data-ds-image-wrap
              className="relative aspect-16/10 overflow-hidden rounded-4xl bg-white shadow-[0_24px_70px_rgba(42,17,87,.12)]"
            >
              <Image
                data-ds-image
                src="/images/asoebi-hero-campaign.png"
                alt="Asoebi Fashion Week hero composition"
                fill
        ...
        <div className="mx-auto max-w-375">
          ...
          <div className="mt-14 grid gap-4 lg:grid-cols-2">
            {motion.map(([title, role, description]) => (
              <article
                key={title}
                className="group rounded-3xl bg-white p-7 shadow-[0_16px_50px_rgba(97,58,13,.09)]"
              >
